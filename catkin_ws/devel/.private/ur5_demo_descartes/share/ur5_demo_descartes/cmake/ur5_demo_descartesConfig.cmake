...
if("TRUE" STREQUAL "TRUE")
  set(ur5_demo_descartes_SOURCE_PREFIX /home/ubuntu/catkin_ws/src/ur5_demo_descartes)
  set(ur5_demo_descartes_DEVEL_PREFIX /home/ubuntu/catkin_ws/devel/.private/ur5_demo_descartes)
  ...
  set(ur5_demo_descartes_INSTALL_PREFIX /home/ubuntu/catkin_ws/install)
...
if(NOT "/home/ubuntu/catkin_ws/src/ur5_demo_descartes/include " STREQUAL " ")
  set(ur5_demo_descartes_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/catkin_ws/src/ur5_demo_descartes/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur5_demo_descartes' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/catkin_ws/src/ur5_demo_descartes/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ur5_demo_descartes_NUM_DUMMY_TARGETS)
      set(ur5_demo_descartes_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ur5_demo_descartes::wrapped-linker-option${ur5_demo_descartes_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ur5_demo_descartes_NUM_DUMMY_TARGETS "${ur5_demo_descartes_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ur5_demo_descartes::wrapped-linker-option${ur5_demo_descartes_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ur5_demo_descartes_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/catkin_ws/devel/.private/ur5_demo_descartes/lib;/home/ubuntu/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(ur5_demo_descartes_EXPORTED_TARGETS ${${ur5_demo_descartes_dep}_EXPORTED_TARGETS})
endforeach()
